 ...
 */
public class individualTraineesAttendance extends javax.swing.JDialog {

    /**
     * Creates new form template
     */
    public individualTraineesAttendance(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Trainees Attendance");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Topic", "Starting Time", "Ending Time", "Name of the Lecture"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(individualTraineesAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                individualTraineesAttendance dialog = new individualTraineesAttendance(new javax.swing.JFrame(), true);
