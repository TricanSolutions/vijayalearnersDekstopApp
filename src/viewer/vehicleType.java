 ...
 */
public class vehicleType extends javax.swing.JDialog {

    /**
     * Creates new form template
     */
    public vehicleType(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vehicleType dialog = new vehicleType(new javax.swing.JFrame(), true);
